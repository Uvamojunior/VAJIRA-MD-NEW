...
global.owner = process.env.OWNER_NUMBER  || '07053174076' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=2ZkEEaYK#8L4KgRv1BF12RgF6uAJEIGVlwWDG_qrTvqZJed1tlQk' ,
